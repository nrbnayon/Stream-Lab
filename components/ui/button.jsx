...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-lg transition-all disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed shrink-0 outline-none focus-visible:border-ring aria-invalid:border-destructive cursor-pointer active:scale-[0.98] [&_svg]:pointer-events-none shrink-0 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
        ...
        destructive:
          "bg-primary text-white shadow-xs hover:bg-primary/90 focus-visible:ring-destructive/20",
        outline:
